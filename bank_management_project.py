...
while True:
    print(f"Welcome to the {ucb.name} bank")
    print("Log in Admin User as admin and password - 123456")
    print("1. Admin")
    print("2. User")
    print("3. Exit")
    ...
    if option == "1":
        ...
        if user_name == admin.name and password == admin.password:
            ...
            while True:
                ...
                if option == "1":
                    ...
                    register.Registration(ucb, new_user)
                elif option == "2":
                    admin.show_users()
                elif option == "3":
        ...
        if len(ucb.users) > 0:
            ...
            log_in = register.login(ucb, user_email, password)
            if log_in:
                while True:
                    ...
                    if option == "1":
                        ...
                        user.deposite(ucb, amount)
                    elif option == "3":
                        amount = int(input("Enter amount:"))
                        user.withdraw(ucb, amount)
                    elif option == "4":
                        name = input("Enter name of receiver:")
                        amount = int(input("Enter amount:"))
                        user.transfer_money(ucb, amount, name)
                    elif option == "5":
                        user.show_transaction_history()
                    elif option == "6":
                        amount = int(input("Enter loan amount:"))
                        user.take_loan(ucb, amount)
                    elif option == "7":
                        register.log_out()
                        break
                    else:
